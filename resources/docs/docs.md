...
The `home-routes` handler in the `d3-cljs.routes.home` namespace
...
The `home-page` function will in turn call the `d3-cljs.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/d3_cljs/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `d3-cljs.handler` namespace:
...
Request middleware functions are located under the `d3-cljs.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `d3-cljs.dev-middleware` namespace found in
